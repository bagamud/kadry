    ...
    <div class="row m-auto col-10">
        <div class="card m-auto d-flex flex-column m-3 p-3">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a id="militaryLink" class="nav-link active" href="${pageContext.request.contextPath}/staff/military">Military</a>
                </li>
            </ul>            <div class="card"><form class="needs-validation" action="${pageContext.request.contextPath}/staff" method="post" name="form"
                  id="formId">
                <div class="row m-3">
